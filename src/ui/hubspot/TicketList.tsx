...
import { ticketPriorityMeta, ticketStageMeta, recordUrl, timeAgo, minusHoursISO, hubspotLogo } from "./lib/hubspot";
...
export default function TicketList(props: Props) {
  ...
  return (
    <Card>
      ...
      />
      {visible.length === 0 && (
        <div className="px-3 py-3 text-[11px] text-text-dim">No tickets match.</div>
      )}
      {visible.map((t, i) => {
