...
import {
 ...
 pillToDot, timeAgo, minusHoursISO, hubspotVendor,
} from "./lib/hubspot";
...
export default function TicketCard(props: Props) {
 ...
 <span className="text-[11px] text-text-dim inline-flex items-center gap-1"><MessageCircle className="w-3 h-3" />{p.comment_count}</span>
 )}
 </div>

 {p.content && (
 <div className="text-xs text-text-muted line-clamp-3 border-l-2 border-border pl-2">
 {p.content}
 </div>
 )}
